...
import org.neo4j.scala.util.{Coord, LinRing}
import org.neo4j.scala.{Neo4jSpatialWrapperUtil, Neo4jWrapperImplicits, IsSpatialDatabaseRecord}
 ...
 * convenience trait
 */
trait MyAllInOneTrait extends IsSpatialDatabaseRecord with Neo4jSpatialWrapperUtil with Neo4jWrapperImplicits
 ...
 */
object NewSpatialNode extends Neo4jSpatialWrapperUtil with Neo4jWrapperImplicits {
